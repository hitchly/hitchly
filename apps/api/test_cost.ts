...
const allTestRiders = [
  ...
  // testRider29,
  // testRider30,
  testRider1, // 1. Local Hamilton (08:45) - The Baseline
  testRider23, // 2. Beamsville (07:35, Comfort) - The Route Match
  testRider6, // 3. Stoney Creek (09:15, Cost) - The Preference Match
  testRider13, // 4. Mississauga (09:50, Comfort) - The GTA Match

  // --- New Additions ---
  testRider21, // 5. Ancaster (08:00) - The Suburban Neighbor
  testRider14, // 6. Toronto Downtown (08:40) - The City Commuter
  testRider9,
];

async function runTest() {
  console.log(
    `🚀 Starting COST PREFERENCE tests for ${allTestRiders.length} riders...`,
  );
