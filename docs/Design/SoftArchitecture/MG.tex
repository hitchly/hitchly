...
This organization improves maintainability, scalability, and adaptability of the system.  
The hierarchy is divided into three main categories: Hardware-Hiding, Behaviour-Hiding,  
...
These modules interface directly with device hardware and operating-system services.  
They abstract away platform-specific APIs to ensure the rest of the system is independent  
of hardware details.

\begin{itemize}
  \item M1: GPS Module
  \item M2: Camera Module
\end{itemize}

\item[\textbf{5.2 Behaviour-Hiding Modules}]  
These modules implement Hitchly’s user-visible features and external integrations.  
They define the functional behaviour of the application, hiding API calls and workflow logic  
from users.

\begin{itemize}
  \item M3: Verification Module
  \item M4: Authentication Module
  \item M5: Matching Module
  \item M6: Mapping Module
  \item M7: Payment Module
  \item M8: Database Module
  \item M9: Notification Module
  \item M10: Rating Module
  \item M11: Search Module
\end{itemize}

\item[\textbf{5.3 Software-Decision Modules}]  
These modules encapsulate the system’s internal computational logic and algorithmic decisions.  
They handle analytics, scheduling, safety enforcement, and pricing calculations that are invisible  
to users.

\begin{itemize}
  \item M12: Analytics Module
  \item M13: Scheduling Module
  \item M14: Safety Module
  \item M15: Pricing Module
\end{itemize}
\end{description}
...
\midrule
Hardware-Hiding Module & M1: GPS Module; M2: Camera Module\\
\midrule
