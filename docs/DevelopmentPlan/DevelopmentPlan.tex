...
\begin{itemize}
	\item Github: This will be the central platform for code collaboration and project task management. 
	\begin{itemize}
    \item The team will use Issues to log tasks and meetings, and to assign responsibilities.
    \item Project boards may be used to help track the team's progress throughout the project.
  \end{itemize}
  \item Discord: This will be used as the primary communication platform for the team. 
        Meetings will take place in the Discord server, as well as any other quick communication, updates, and questions.
  \item Microsoft Teams: Teams will also be used to share files and documents to stay organized.
  \item Outlook: Email will be used to communicate with the Professor, TA, and any other external inqueries related to the project.
\end{itemize}
