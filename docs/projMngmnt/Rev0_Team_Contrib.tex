...
This will build on top of the POC and this time, it will showcase the application's functionality with a clear User Interface. 
...
signs-up/logs-in, selects their user type (driver or rider), and show their respective functionalities like matchmaking and cost estimation. 
